...
//任务堆栈大小	
#define CSMACA_PBFT_STK_SIZE 		4096  
//任务句柄
...
//	//左轮前进                  // PF12 0 前进 1后退
								//0 数越小约快   1数约大约快
	GPIO_Pin_Set(GPIOF,PIN12,1);
	TIM4->CCR4 =300;	//PD15    TIM4-CH4
//	GPIO_Pin_Set(GPIOD,PIN15,1);
//	//右轮前进				// PA12 0 前进 1后退
							//0 数越小约快   1数约大约快
//	GPIO_Pin_Set(GPIOD,PIN14,1);
	GPIO_Pin_Set(GPIOA,PIN7,1);
	TIM4->CCR3 = 300;//PD14    TIM4-CH3
