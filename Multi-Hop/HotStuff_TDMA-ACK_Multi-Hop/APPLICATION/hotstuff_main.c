...
/**************************Pre-commit**************************/
	...
	while(1){
		...
		if(id==Group_Leader_ID && commit_flag){
			u8 tmp_flag = 0;
...
/**************************Pre-commit**************************/
	...
	while(1){
		...
		if(id==Global_Consensus_Leader && commit_flag){
			u8 tmp_flag = 0;
...
void Global_Go_ACK(){
	...
	if(Global_ACK_TO_Send_Number >= MAX_ACK_NUMBER ){
		Global_ACK_TO_Send_Number = MAX_ACK_NUMBER;
		return;
	}
